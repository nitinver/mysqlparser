...
struct tokens : lex::lexer<Lexer>
{
    tokens() 
    {
        keyword_ = "select|SELECT|from|FROM|where|WHERE|limit|LIMIT|order|ORDER|by|BY|alias|ALIAS";
        dot_     = '.';
        multiply_    = '*';
        popen_   = '(';
        pclose_  = ')';
        ...
        this->self += keyword_ | dot_ | multiply_ | popen_ | pclose_ | bopen_ | bclose_ | iopen_ | iclose_ | colon_ | semic_ | comma_ | tern_q_
  ...
  private:
    lex::token_def<> keyword_, dot_, multiply_, popen_, pclose_, bopen_, bclose_, iopen_, iclose_, colon_, semic_, comma_, tern_q_;
